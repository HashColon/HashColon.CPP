...
HashColon::CommonLogger::_Params HashColon::CommonLogger::_cDefault;
std::mutex HashColon::CommonLogger::_mutex;
...
HashColon::ResultPrinter::_Params HashColon::ResultPrinter::_cDefault;
namespace HashColon
{
	using namespace std;

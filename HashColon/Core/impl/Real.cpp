...
namespace HashColon
{
	HashColon::_details::hiddenAnchor _anchor;
	Real HashColon::_details::hiddenAnchor::_minDegree = -180.0;
	Real HashColon::_details::hiddenAnchor::_maxDegree = 180.0;

	Real HashColon::_details::hiddenAnchor::_negativePI = -3.14159265358979323846;
	Real HashColon::_details::hiddenAnchor::_positivePI = 3.14159265358979323846;

	Real HashColon::_details::hiddenAnchor::_realZero = 0.0;
	Real HashColon::_details::hiddenAnchor::_realTen = 10.0;
	Real HashColon::_details::hiddenAnchor::_realMax = std::numeric_limits<Real>::max();

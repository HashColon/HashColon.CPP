#ifndef HASHCOLON_CAGD
#define HASHCOLON_CAGD
...
namespace HashColon::CAGD
{
	...
	protected:
		GeometryBase(
			const PointArrT<Dim> &featurePoints = PointArrT<Dim>::Zero(Dim, 1)) : FeaturePoints(featurePoints){};
	...
	public:
		...
		{
			this->FeaturePoints = rhs.FeaturePoints;
			basis = rhs.basis;
			return *this;
		};
